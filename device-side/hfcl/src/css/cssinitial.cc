...
CssInitial::CssInitial ()
{
    ...
    m_values[PID_FONT] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_KEYWORD, PVK_USE_OTHERS);

    m_values[PID_FONT_FAMILY] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_KEYWORD, PVK_SERIF);

    m_values[PID_FONT_SIZE] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_LENGTH_PX, PVK_USER_DATA);
    ...
    m_values[PID_HVML_PSEUDO] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_NOT_INHERITED, PVT_KEYWORD, PVK_JUSTIFY_ALL);

    m_values[PID_HYPHENS] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_KEYWORD, PVK_MANUAL);
    ...
    m_values[PID_LINE_BREAK] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_KEYWORD, PVK_AUTO);
    ...
    m_values[PID_OVERFLOW_WRAP] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_KEYWORD, PVK_NORMAL);
    ...
    m_values[PID_TAB_SIZE] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_NUMBER, PVK_USER_DATA);
    m_data[PID_TAB_SIZE].r = 8;

    m_values[PID_TEXT_ALIGN_ALL] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_KEYWORD, PVK_START);

    m_values[PID_TEXT_ALIGN_LAST] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_KEYWORD, PVK_AUTO);
    ...
    m_values[PID_TEXT_JUSTIFY] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_KEYWORD, PVK_AUTO);
