...
CssInitial::CssInitial ()
{
    ...
    m_values[PID_BORDER_COLLAPSE] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_KEYWORD, PVK_SEPARATE);
    ...
    m_values[PID_BORDER_SPACING] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_LENGTH_PX, PVK_USER_DATA);
    m_data[PID_BORDER_SPACING].r = 0;
    ...
    m_values[PID_CAPTION_SIDE] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_KEYWORD, PVK_TOP);
    ...
    m_values[PID_EMPTY_CELLS] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_INHERITED, PVT_KEYWORD, PVK_SHOW);
    ...
    m_values[PID_TABLE_LAYOUT] = MAKE_CSS_PPT_INITIAL_VALUE(CSS_PPT_VALUE_FLAG_NOT_INHERITED, PVT_KEYWORD, PVK_AUTO);
