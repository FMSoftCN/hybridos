...
PVCHECKERS_FILE="../../src/css/pvcheckers.inc"
...
#    print("DONE")
    ...
    try:
        fdst = open(PVCHECKERS_FILE, "w")
    except:
        print("%s: failed to open output file %s" % (TOOL_NAME, PVCHECKERS_FILE, ))
        sys.exit(12)

    print("Writting property value checkers to dst file %s..." % PVCHECKERS_FILE)
    try:
