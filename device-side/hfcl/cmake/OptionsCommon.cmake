...
if (WTF_CPU_ARM64_CORTEXA53)
    ...
    HFCL_PREPEND_GLOBAL_COMPILER_FLAGS(-mfix-cortex-a53-835769)
endif ()
...
HFCL_CHECK_HAVE_INCLUDE(HAVE_FEATURES_H features.h)

# Check for headers
HFCL_CHECK_HAVE_INCLUDE(HAVE_ERRNO_H errno.h)
HFCL_CHECK_HAVE_INCLUDE(HAVE_LANGINFO_H langinfo.h)
HFCL_CHECK_HAVE_INCLUDE(HAVE_MMAP sys/mman.h)
HFCL_CHECK_HAVE_INCLUDE(HAVE_PTHREAD_NP_H pthread_np.h)
HFCL_CHECK_HAVE_INCLUDE(HAVE_STRINGS_H strings.h)
HFCL_CHECK_HAVE_INCLUDE(HAVE_SYS_PARAM_H sys/param.h)
HFCL_CHECK_HAVE_INCLUDE(HAVE_SYS_TIME_H sys/time.h)
HFCL_CHECK_HAVE_INCLUDE(HAVE_SYS_TIMEB_H sys/timeb.h)
HFCL_CHECK_HAVE_INCLUDE(HAVE_LINUX_MEMFD_H linux/memfd.h)

# Check for functions
HFCL_CHECK_HAVE_FUNCTION(HAVE_ALIGNED_MALLOC _aligned_malloc)
HFCL_CHECK_HAVE_FUNCTION(HAVE_ISDEBUGGERPRESENT IsDebuggerPresent)
HFCL_CHECK_HAVE_FUNCTION(HAVE_LOCALTIME_R localtime_r)
HFCL_CHECK_HAVE_FUNCTION(HAVE_MALLOC_TRIM malloc_trim)
HFCL_CHECK_HAVE_FUNCTION(HAVE_STRNSTR strnstr)
HFCL_CHECK_HAVE_FUNCTION(HAVE_TIMEGM timegm)
HFCL_CHECK_HAVE_FUNCTION(HAVE_VASPRINTF vasprintf)

# Check for symbols
HFCL_CHECK_HAVE_SYMBOL(HAVE_REGEX_H regexec regex.h)
if (NOT (${CMAKE_SYSTEM_NAME} STREQUAL "Darwin"))
HFCL_CHECK_HAVE_SYMBOL(HAVE_PTHREAD_MAIN_NP pthread_main_np pthread_np.h)
endif ()
# Windows has signal.h but is missing symbols that are used in calls to signal.
HFCL_CHECK_HAVE_SYMBOL(HAVE_SIGNAL_H SIGTRAP signal.h)

# Check for struct members
HFCL_CHECK_HAVE_STRUCT(HAVE_STAT_BIRTHTIME "struct stat" st_birthtime sys/stat.h)
HFCL_CHECK_HAVE_STRUCT(HAVE_TM_GMTOFF "struct tm" tm_gmtoff time.h)
HFCL_CHECK_HAVE_STRUCT(HAVE_TM_ZONE "struct tm" tm_zone time.h)
