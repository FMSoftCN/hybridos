...
HFCL_OPTION_BEGIN()
HFCL_OPTION_DEFINE(ENABLE_STATIC_JSC "Whether to build JavaScriptCore as a static library." PUBLIC OFF)
...
if (WIN32)
    ...
    if (NOT HFCL_LIBRARIES_DIR)
        if (DEFINED ENV{HFCL_LIBRARIES})
            set(HFCL_LIBRARIES_DIR "$ENV{HFCL_LIBRARIES}")
        else ()
            set(HFCL_LIBRARIES_DIR "${CMAKE_SOURCE_DIR}/HfclLibraries/win")
        endif ()
    endif ()
