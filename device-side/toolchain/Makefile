...
$(TOOLCHAIN_DIR)/stamp/.wrapper_installed:
endif

ifeq ($(CONFIG_UPDATE_TOOLCHAIN), y)
$(eval $(call stampfile,$(curdir),toolchain,install,$(TOOLCHAIN_DIR)/stamp/.gcc-initial_installed,_local,$(TOOLCHAIN_DIR)))
else
$(eval $(call stampfile,$(curdir),toolchain,install,$(TOOLCHAIN_DIR)/stamp/.wrapper_installed,_external,$(TOOLCHAIN_DIR)))
endif
