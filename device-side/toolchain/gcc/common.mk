...
ifeq ($(CONFIG_GCC_VERSION),"4.5-2010.09")
  PKG_MD5SUM:=b4e1f518748c51b792e77a5eb9020e8b
  PKG_VERSION:=4.5.1
  HOST_BUILD_DIR:=$(COMPILE_DIR_TOOLCHAIN)/$(GCC_DIR)
  PKGVERSION=OpenWrt/CodeSourcery GCC $(PKG_VERSION) $(REVISION)
endif

ifeq ($(CONFIG_GCC_VERSION),"4.8-2014.05")
  PKG_MD5SUM:=00025b4618e33132fc5863ea9fb7c3ed
  PKG_VERSION:=4.8.3
  HOST_BUILD_DIR:=$(COMPILE_DIR_TOOLCHAIN)/$(GCC_DIR)
  PKG_SOURCE:=$(PKG_NAME)-$(CONFIG_GCC_VERSION).tar.bz2
  PKGVERSION=OpenWrt/CodeSourcery GCC $(PKG_VERSION) $(REVISION)
endif
...
ifeq ($(CONFIG_GCC_VERSION),"4.5-2010.09")
  GCC_CONFIGURE += --enable-extra-sgxxlite-multilibs
endif
...
GCC_MAKE:= \
	...
	$(MAKE) \
		CFLAGS="$(HOST_CFLAGS)" \
		CFLAGS_FOR_TARGET="$(TARGET_CFLAGS) $(if $(CONFIG_GCC_USE_VERSION_4_5_1),-O2)" \
