...
if (mGEff_VERSION)
    if (mGEff_FIND_VERSION_EXACT)
        if (NOT("${mGEff_FIND_VERSION}" VERSION_EQUAL "${mGEff_VERSION}"))
            set(VERSION_OK FALSE)
        endif ()
    else ()
        if ("${mGEff_VERSION}" VERSION_LESS "${mGEff_FIND_VERSION}")
            set(VERSION_OK FALSE)
        endif ()
    endif ()
endif ()

if (NOT mGEff_INCLUDE_DIRS)
    set(mGEff_INCLUDE_DIRS ${mGEff_INCLUDEDIR})
endif ()

include(FindPackageHandleStandardArgs)
FIND_PACKAGE_HANDLE_STANDARD_ARGS(mGEff DEFAULT_MSG mGEff_INCLUDE_DIRS mGEff_LIBRARIES VERSION_OK)
