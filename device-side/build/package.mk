...
PKG_BUILD_DIR ?= $(COMPILE_DIR)/$(PKG_NAME)$(if $(PKG_VERSION),-$(PKG_VERSION))
...
include $(BUILD_DIR)/package-defaults.mk
include $(BUILD_DIR)/package-dumpinfo.mk
include $(BUILD_DIR)/package-ipkg.mk
include $(BUILD_DIR)/package-bin.mk
include $(BUILD_DIR)/autotools.mk

override MAKEFLAGS=
CONFIG_SITE:=$(BUILD_DIR)/site/$(ARCH)
